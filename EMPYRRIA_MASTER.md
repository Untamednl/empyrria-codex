...
- **Presentation only** — **no** JSON keys added/removed; **no** **`slug`** or route contract change; **`name`** remains registry identity for **alt** text and **subtitle** when **`title`** is the headline.  
